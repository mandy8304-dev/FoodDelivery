...
class AddDistributorFragment : Fragment() {
    ...
    private var pathCard: String = ""
    private  var outputFileUri: Uri? = null
    private var uriPrevious: Uri? = null

    private var type: Int = 0 //0 => Photo  1 => Card
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnUploadDriverCard.setOnClickListener {
            onUploadDriverCard()
        }
    }

    private fun onUploadDriverCard() {
        options(1)
    }
...
//        }
    ...
    private fun onPermissionTakePhoto() {
        ...
        Dexter.withContext(activity)
            ...
            .withListener(AppPermissionListener(this@AddDistributorFragment))
            .check()

    }

    inner class AppPermissionListener(private val activity: AddDistributorFragment) :
        PermissionListener {
    ...
    private fun onImageCrop(aUriSource: Uri, aUriDestination: Uri) {
        ...
        UCrop.of(aUriSource, aUriDestination)
            .withOptions(options)
            .start(requireContext(), this@AddDistributorFragment)
    ...
    private fun handleCropResult(@NonNull result: Intent) {
        ...
        if (resultUri != null) {
            ...
            if (type == 0) {
                ...
                Logger.e("Path photo $path")
            } else {
                pathCard = path!!
                Logger.e("Path card $path")
            }
